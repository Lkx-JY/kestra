...
public interface FlowMetaStoreInterface {
     ...
     * WARNING: this method will NOT check if the namespace is allowed, so it should not be used inside a task.
     */
    Optional<FlowWithSource> findByIdThenInjectDefaults(String tenantId, String namespace, String id, Optional<Integer> revision);

    /**
     * Same as {@link #findByIdThenInjectDefaults(String, String, String, Optional)}, checking that the namespace
     ...
     */
    Optional<FlowWithSource> findByIdFromTaskThenInjectDefaults(String tenantId, String namespace, String id, Optional<Integer> revision, String fromTenant,
